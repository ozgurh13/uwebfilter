...
if __name__ == '__main__':
    ...
    cmdline = argparse.ArgumentParser(description='website classification model trainer')

    cmdline.add_argument('dataset', help='dataset to be trained on')
    cmdline.add_argument('--name', type=str, required=True, help='name of the output model')
    cmdline.add_argument('--verbose', action='store_true', help='enable verbose mode')
